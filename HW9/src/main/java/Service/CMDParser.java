...
/**
 * CMDParser is a method to parser the command lines and get corresponding next argument of the command lines
 */
public class CMDParser{
   ...
   */
  public String getNextArgument(String[] commands) {
