...
//    return resultingTopics;
  ...
  public static List<String> replaceWord_nonFunctional(List<String> listOfWords, String offensiveWord, String replacementWord){
  ...
  public static List<String> replaceWord(List<String> listOfWords, String offensiveWord, String replacementWord){
    ...
    resultingList = listOfWords.stream()
                                .map(x -> {if(x.equals(offensiveWord)){x = replacementWord;} return x;})
                                .collect(Collectors.toList());
    return resultingList;
  }

  private String returnOrReplace(String originalWord, String offensiveWord, String replacementWord){
    if(originalWord.equals(offensiveWord))
      return replacementWord;
    else return (String) originalWord;
  }
