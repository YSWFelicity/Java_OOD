...
/*Class Swimmer contains information about a swimmer, and the list of their swimming times, when swimming 50m.
Four swimming styles are considered: butterfly, backstroke, breaststroke, and freestyle.
 */
public class Swimmer implements Comparable<Swimmer> {
  ...
  public Swimmer(String name, List<Double> butterfly50mTimes,
    ...
    this.freestyle50Times = freestyle50Times;
  }
  ...
  public List<Double> getFreestyle50Times() {
    return freestyle50Times;
  }
...
//    Double fastestSwimTime = 300.0;
//    for (Double swimTime: swimTimes) {
//      if(fastestSwimTime > swimTime)
//        fastestSwimTime = swimTime;
//    }return fastestSwimTime;
   ...
   *
   * @param otherSwimmer the object to be compared.
  ...
  public int compareTo(Swimmer otherSwimmer) {
    return this.getAverageSwimTime(this.getFreestyle50Times())
            .compareTo(getAverageSwimTime(otherSwimmer.getFreestyle50Times()));
  }
