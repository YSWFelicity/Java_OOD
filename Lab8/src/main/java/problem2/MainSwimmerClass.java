  ...
  public static void main(String[] args){
    ...
    for (Swimmer swimmer: swimmersMain.swimmers) {
      StringBuilder stringToPrint = new StringBuilder(
          swimmer + swimmer.getAverageSwimTime(swimmer.getFreestyle50Times()).toString());
    ...
    for (Swimmer swimmer: swimmersMain.swimmers) {
      StringBuilder stringToPrint = new StringBuilder(swimmer + swimmer.getFastestSwimTime(swimmer.getFreestyle50Times()).toString());
      System.out.println(stringToPrint.toString());
    }
    ...
    Comparator<Swimmer> slowestSwimTime = new Comparator<Swimmer>() {
      ...
      public int compare(Swimmer o1, Swimmer o2) {
        return o1.getSlowestSwimTime(o1.getFreestyle50Times())
            .compareTo(o2.getSlowestSwimTime(o2.getFreestyle50Times()));
      }
    };
    ...
    for (Swimmer swimmer: swimmersMain.swimmers) {
      StringBuilder stringToPrint = new StringBuilder(swimmer +
              swimmer.getSlowestSwimTime(swimmer.getFreestyle50Times()).toString());
      System.out.println(stringToPrint.toString());
    }
