...
class FoodItemTest {
  ...
  void setUp() {
      ...
      testFruit = new Fruit("Apple", 2.99, 25, FoodItem.MAX_PERISHABLE_QUANTITY,
  ...
  void testEquals_OtherRiceObject_DifferentName() {
    Rice myOtherRice = new Rice("Brown rice", 3.99, 50, FoodItem.MAX_NON_PERISHABLE_QUANTITY);
    assertFalse(myTestRice.equals(myOtherRice));
  }

  @Test
  void testEquals_OtherRiceObject_DifferentPrice() {
    Rice myOtherRice = new Rice("Brown rice", 5.99, 50, FoodItem.MAX_NON_PERISHABLE_QUANTITY);
    assertFalse(myTestRice.equals(myOtherRice));
  }

  @Test
  void testEquals_OtherRiceObject_DifferentMaxQuantity() {
    Rice myOtherRice = new Rice("Brown rice", 3.99, 100, FoodItem.MAX_NON_PERISHABLE_QUANTITY);
    assertFalse(myTestRice.equals(myOtherRice));
  }

  @Test
  void testEquals_DifferentMaxQuantity() {
    Fruit myOtherFruit = new Fruit("Apple", 2.99, 35, 123,
        testOrderDate, testExpirationDate);
    assertFalse(testFruit.equals(myOtherFruit));
  }
  ...
  //hashcode test for perishable item -- Questions
//  @Test
...
//  }
  ...
  void testToString_NonPerishable() {
    Pasta myTestPasta = new Pasta("Rigatoni", 2.50,
            35,FoodItem.MAX_NON_PERISHABLE_QUANTITY);
