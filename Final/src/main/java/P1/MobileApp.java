...
public class MobileApp {
  ...
  public MobileApp(String appName, MobileAppCategory appCategory, Float currentVersion,
      Float currentSize, List<Name> developers, List<String> requestedPermissions,
      LocalDate dateOfOriginalRelease, LocalDate dateOfLatestUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(appName, mobileApp.appName)
        && appCategory == mobileApp.appCategory && Objects.equals(currentVersion,
        mobileApp.currentVersion) && Objects.equals(currentSize, mobileApp.currentSize)
        && Objects.equals(developers, mobileApp.developers) && Objects.equals(
        requestedPermissions, mobileApp.requestedPermissions) && Objects.equals(
        dateOfOriginalRelease, mobileApp.dateOfOriginalRelease) && Objects.equals(
        dateOfLatestUpdate, mobileApp.dateOfLatestUpdate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appName, appCategory, currentVersion, currentSize, developers,
        requestedPermissions, dateOfOriginalRelease, dateOfLatestUpdate);
  }
