 ...
 * and the number of season honme runs.
 */
public class BaseballPlayer extends Athlete{
     ...
     * @param seasonHomeRuns - baseball player's season home runs, stored as a Integer
     */
    public BaseballPlayer(Name athletesName, Double height, Double weight,
                          String league, String team, Double avgBattingScore, Integer seasonHomeRuns) {
     ...
     * @param avgBattingScore - avg. batting score, as a Double
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(team, that.team) && Objects.equals(avgBattingScore, that.avgBattingScore) && Objects.equals(seasonHomeRuns, that.seasonHomeRuns);
    }
    ...
    public String toString() {
        return "BaseballPlayer{" +
                ...
                ", league='" + this.league + '\'' +
                ", team='" + this.team + '\'' +
                ", avgBattingScore=" + this.avgBattingScore +
